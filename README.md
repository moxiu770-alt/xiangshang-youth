...
- **权限与系统能力**：照片/文件选择、相机、通知、分享、系统浏览器和外部登录回跳需要统一权限解释、拒绝后的可恢复路径及降级 UI。
...
- **发布配置**：生产 Bundle/Application ID、隐私清单、通知权限说明、文件/相机权限文案、深链/Universal Link、签名、Release 构建和崩溃兜底页。
