 ...
 */
class RemoteRepository(private val reportFallback: YouthRepository = MockRepository()) : YouthRepository {
    override suspend fun dashboard(): DashboardData = throw ApiError.NotConfigured
