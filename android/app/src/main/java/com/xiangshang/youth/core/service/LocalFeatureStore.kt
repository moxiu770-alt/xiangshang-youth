...
data class ActivityRegistration(val id: String = java.util.UUID.randomUUID().toString(), val activityId: String, val contactName: String, val phone: String, val status: LocalSubmissionStatus = LocalSubmissionStatus.PendingSync)
...
data class ExpertAppointment(val id: String = java.util.UUID.randomUUID().toString(), val expertName: String, val preferredDate: String, val note: String, val status: LocalSubmissionStatus = LocalSubmissionStatus.PendingSync)
