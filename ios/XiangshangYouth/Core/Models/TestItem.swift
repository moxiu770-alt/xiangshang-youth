...
enum TestItem: String, CaseIterable, Identifiable, Codable {
    ...
    var icon: String { switch self { case .obstacleJump: "figure.jump.rope"; case .lateralSlide: "arrow.left.and.right"; case .backwardBalance: "figure.walk"; case .catchThrow: "target"; case .handDribble: "basketball"; case .footDribble: "soccerball"; case .spotKick: "scope" } }
}
