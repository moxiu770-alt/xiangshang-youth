        ...
        ScrollView {
            VStack(spacing: 10) {
                ...
                if visiblePosts.isEmpty {
                    pinnedAnnouncementPost(author: "李老师", content: "本周运动打卡已开启，欢迎家长分享孩子的练习瞬间。", isTeacher: true, isLiked: $pinnedAnnouncementLiked, commentCount: state.localFeatures.classPostComments.filter { $0.postID == pinnedNoticeID }.count, onComment: { commentSubmitted = false; commentDraft = ""; commentPostID = pinnedNoticeID })
                }
