                        ...
                        Button {
                            ...
                            HStack(spacing: 10) {
                                ...
                                VStack(alignment: .leading, spacing: 4) {
                                    HStack(spacing: 5) { Text(item.title).font(.system(size: 16, weight: .bold)); if unread { Circle().fill(.red).frame(width: 5, height: 5) } }
                                    Text(item.content).font(.system(size: 16)).foregroundStyle(.secondary)
                                }
                                Spacer()
        ...
        .sheet(item: $selectedMessage) { message in
            NavigationStack {
                VStack(alignment: .leading, spacing: 14) {
                    ...
                    Text(message.message.time).font(.subheadline).foregroundStyle(.secondary)
                    Divider()
