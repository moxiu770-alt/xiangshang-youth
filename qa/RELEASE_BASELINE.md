...
3. `python3 scripts/check_migration_sequence.py`、`check_frontend_contract.py` 与 `check_model_contract.py` 通过；
...
- iOS：会话/角色恢复、领域数据投影、课程、健康、通知、排期、教师任务和支持能力分别位于 `AppState+*.swift`；角色入口、家庭账户、家庭消息、身体基础数据、姿态算法和结果视图已分文件。
